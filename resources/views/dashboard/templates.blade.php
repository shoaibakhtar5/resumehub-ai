...
<x-app-layout title="Resume Templates" mode="user">
    <div x-data="{ tab: 'popular', category: 'All Categories' }" class="space-y-8">
        ...
        <div class="rh-scrollbar-hide flex gap-3 overflow-x-auto pb-1">
        ...
        @else
            <section class="grid gap-5 sm:grid-cols-2 xl:grid-cols-4">
                @foreach ($templates as $template)
                    ...
                    <article x-show="category === 'All Categories' || category === '{{ $category }}'" class="group overflow-hidden rounded-xl border border-outline-variant/20 bg-white shadow-soft transition duration-300 hover:-translate-y-1 hover:shadow-lift">
